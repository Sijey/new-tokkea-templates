                ...
                <mj-group>
                    <mj-column vertical-align="middle">
                        ...
                        <mj-text css-class="content-text">
                            Your token sale application has confirmed.
                            <br /> <br />
                            If you have any suggestions or need assistance, feel free to contact your Personal Manager by telegram group of your project.
                            <br /> <br />
                        </mj-text>
                        <mj-button background-color="#479D7E" border-radius="6px" align="left" href="#">Token Sale Page</mj-button>
