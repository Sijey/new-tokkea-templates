                ...
                <mj-group>
                    <mj-column vertical-align="middle">
                        <mj-text css-class="content-title">
                            <span>Welcome to Tokkea Exchange!</span>
                        </mj-text>
                        <mj-divider border-width="1px" padding="20px 0" border-color="#EEEEEE" />
                        <mj-text css-class="content-text">
                            Thank you for the registration.
                            Confirm your email address and secure your
                            account by verification and 2FA to have full
                            access to the exchange services.
                            <br /> <br />
                        </mj-text>
                        <mj-button background-color="#479D7E" border-radius="6px" align="left" href="#">Confirm email</mj-button>
